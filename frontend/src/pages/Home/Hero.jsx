    ...
    <div className="container mx-auto min-h-screen flex flex-col items-center justify-center p-8 pt-20 text-center">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="inline-flex items-center px-4 py-2 bg-blue-100 rounded-full mb-6 dark:bg-blue-500/10">
          ...
          <span className="text-blue-600 font-medium dark:text-blue-400">NUEVO • Versión 1.5</span>
        </div>
        ...
        <div className="flex flex-wrap gap-4 justify-center mb-16">
          ...
          <button
            ...
            aria-label="Ver demostración de las herramientas de scanlation"
          >
          ...
          <button
            ...
            aria-label="Únete a nuestra comunidad de Discord para scanlators"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-2xl mx-auto" role="list" aria-label="Características principales de Komiix">
