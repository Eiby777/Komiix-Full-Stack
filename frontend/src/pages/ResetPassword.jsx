...
import { Book, Lock, ChevronRight, X } from 'lucide-react';
...
export default function ResetPassword() {
  ...
  const handlePasswordReset = async (e) => {
    ...
    try {
      // Verificar el token de acceso primero
      ...
      setSuccessMessage('¡Contraseña actualizada con éxito! Redirigiendo al inicio...');
