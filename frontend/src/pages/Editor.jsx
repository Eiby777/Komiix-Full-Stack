...
import EditorCanvas from "../components/editor/canvas/EditorCanvas/EditorCanvas";
import LayersPanel from "../components/editor/layers/Layers";
import SettingsPanel from "../components/editor/settings/SettingsPanel";
import Header from "../components/editor/header/Header";
import ZoomControls from "../components/editor/canvas/ZoomControls";
import ToolsSideBar from "../components/editor/toolbar/Toolbar";
import UndoRedoMenu from "../components/editor/canvas/UndoRedoMenu/UndoRedoMenu";
